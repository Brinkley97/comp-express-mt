...
CUDA_VISIBLE_DEVICES=1 python run_translation_49.py \
...
CUDA_VISIBLE_DEVICES=3,2 python run_translation_49.py \
    --model_name_or_path google/byt5-base \
    --do_train \
    --do_eval \
    --source_lang yo \
...
CUDA_VISIBLE_DEVICES=1 python run_translation_49.py \
    --model_name_or_path byt5_yo_en/yo_en \
    --source_lang yo \
    --target_lang en \
    --source_prefix "translate Yoruba to English: " \
    --train_file data/yo_en/train.json \
